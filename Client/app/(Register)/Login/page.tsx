  ...
  return (
    <>
      {Token ? 
        <>
          <AccessDenied/>
          <a href="Dashboard" className="bg-lime-500 px-5 py-3 cursor-pointer">Dashboard</a>
        </> 
      : 
        ...
        >
          ...
          >
            ...
            <div className="w-full h-3/5 p-4 flex flex-col gap-5 justify-center" style={{fontFamily:"Vazir"}}>
              ...
              >
                <span className="text-neutral-100">{Loading ? <LoadingIcon className="text-neutral-50 m-auto" /> : 'Login'}</span>
              </button>
            </div>
