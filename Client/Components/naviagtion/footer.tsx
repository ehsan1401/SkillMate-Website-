    ...
    <footer className="w-full lg:h-64 bg-gradient-to-tr from-neutral-50 to-neutral-400 dark:from-neutral-500 dark:to-neutral-900 flex flex-col-reverse lg:flex-row">
        <div className="lg:w-2/5 w-full h-full flex justify-center lg:items-start items-center flex-col lg:py-10">
            <div className="px-10 flex h-1/2 items-center">
                ...
                <h2
                className="flex items-center h-full text-5xl pt-5 dark:bg-gradient-to-tr dark:from-neutral-100 dark:via-blue-300 dark:to-blue-500 bg-clip-text dark:text-transparent text-[#2b80da] font-scriptMtbold"
                >
                SkillMate
                </h2>

            </div>
            <div className="pb-5 lg:pl-14 lg:pr-5 px-12 text-center lg:text-left dark:text-white flex flex-col gap-2 font-vazir"> 
                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quia velit provident porro earum iste rerum deserunt suscipit? 
                <br /><span className="text-center dark:text-white lg:hidden font-Centaur">&copy; 2025 Skillmate. All rights reserved.</span>
            </div>
        ...
        <div className="lg:w-2/5 w-full lg:h-full h-auto lg:flex-row flex flex-col text-xl lg:pb-5">
            ...
            <div className="lg:w-1/3 w-full h-full lg:py-12 py-1 text-xl px-1 flex flex-col justify-center items-center lg:block">
                ...
                <ul className="flex justify-center items-center lg:items-start flex-col gap-4 h-full font-vazir">
            ...
            <div className="lg:w-1/3 w-full h-full lg:py-12 py-1 text-xl px-1 flex flex-col justify-center items-center lg:block">
                ...
                <ul className="flex justify-center lg:items-start items-center flex-col gap-4 h-full font-vazir">
        ...
        <div className="lg:w-2/6 w-full lg:h-full h-auto flex flex-col">
            <div className="w-full h-1/2 flex flex-col justify-center items-center gap-2 py-5">
                <h1 className="text-3xl font-bold dark:text-white font-TwCenMt">Tools</h1>
                <DarkModeToggle />
            </div>

            <div className="w-full h-1/2 flex flex-col justify-center items-center gap-2 lg:py-10 pb-3">
                <h1 className="text-3xl font-bold dark:text-white font-TwCenMt">Contact us!</h1>
                ...
                <span className="text-center dark:text-white lg:block hidden font-Centaur">&copy; 2025 Skillmate. All rights reserved.</span>
            </div>
        </div>
    </footer>
  );
